...
int libSearchById(int id) {
    return searchBookById(id);
}

int libSearchByTitle(char t[]) {
    return searchBookByTitle(t);
}
...
void updateBookTitle(int i) {
    printf("New Title: ");
    scanf(" %[^\n]", library[i].title);
}

void updateBookAuthor(int i) {
    printf("New Author: ");
    scanf(" %[^\n]", library[i].author);
}
